...
namespace HGN_Task3.Migrations
{
    ...
    [Migration("20251103104335_bfuoa")]
    partial class bfuoa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HGN_Task3.Models.BaseModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HGN_Task3.Models.Flashcard", b =>
                {
                    b.HasBaseType("HGN_Task3.Models.BaseModel");
            ...
            modelBuilder.Entity("HGN_Task3.Models.FlashcardsListModel", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("FlashcardsListModel");
                });
            ...
            modelBuilder.Entity("HGN_Task3.Models.FormerResponse", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("FormerResponse");
                });
            ...
            modelBuilder.Entity("HGN_Task3.Models.UserFullResponse", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("UserFullResponse");
                });
            ...
            modelBuilder.Entity("HGN_Task3.Models.UserItemResponse", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("UserItemResponse");
                });
            ...
            modelBuilder.Entity("HGN_Task3.Models.UserRequest", b =>
                {
                    ...
                    b.ToTable("BaseModels", t =>
                        {
                            t.Property("UserId")
                                .HasColumnName("UserRequest_UserId");
                        });
